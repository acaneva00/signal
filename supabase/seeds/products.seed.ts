...
const superFunds: ProductRow[] = [
...

  {
    ...
    investment_options: [
      { name: 'High Growth Pool (Lifecycle default)', investment_fee_pct: 0.10 },
      { name: 'Balanced Pool', investment_fee_pct: 0.59 },
      { name: 'Diversified Bonds Pool', investment_fee_pct: 0.40 },
    ],
...

  {
    ...
    investment_options: [
      { name: 'High Growth', investment_fee_pct: 0.48 },
      { name: 'Growth', investment_fee_pct: 0.44 },
      { name: 'Balanced Growth', investment_fee_pct: 0.38 },
      { name: 'Conservative Growth', investment_fee_pct: 0.32 },
    ],
...

  {
    ...
    investment_options: [
      { name: 'Growth (MySuper)', investment_fee_pct: 0.44, total_fee_pct: 0.60 },
      { name: 'High Growth', investment_fee_pct: 0.56 },
      { name: 'Conservative Growth', investment_fee_pct: 0.36 },
      { name: 'Cash Savings', investment_fee_pct: 0.10 },
    ],
...

  {
    ...
    investment_options: [
      { name: 'Balanced Growth (MySuper)', investment_fee_pct: 0.53, total_fee_pct: 0.68 },
      { name: 'High Growth', investment_fee_pct: 0.58 },
      { name: 'Sustainable Growth', investment_fee_pct: 0.61 },
      { name: 'Indexed Balanced Growth', investment_fee_pct: 0.09 },
      { name: 'Cash', investment_fee_pct: 0.10 },
    ],
...

  {
    ...
    investment_options: [
      { name: 'Balanced (MySuper)', investment_fee_pct: 0.88, total_fee_pct: 1.04 },
      { name: 'Indexed Balanced', investment_fee_pct: 0.10, total_fee_pct: 0.26 },
      { name: 'Shares Plus', investment_fee_pct: 0.67 },
      { name: 'Capital Stable', investment_fee_pct: 0.56 },
    ],
    data_as_at: '2025-01-01',
  },

  {
    ...
    investment_options: [
      { name: 'Growth (default)', investment_fee_pct: 0.57 },
      { name: 'High Growth', investment_fee_pct: 0.61 },
      { name: 'Balanced', investment_fee_pct: 0.50 },
      { name: 'Diversified', investment_fee_pct: 0.44 },
      { name: 'Cash', investment_fee_pct: 0.10 },
    ],
    data_as_at: '2025-01-01',
  },

  {
    ...
    investment_options: [
      { name: 'Balanced (MySuper)', investment_fee_pct: 0.36, total_fee_pct: 0.48 },
      { name: 'High Growth', investment_fee_pct: 0.42 },
      { name: 'Conservative Balanced', investment_fee_pct: 0.32 },
      { name: 'Australian Shares', investment_fee_pct: 0.22 },
      { name: 'Listed Property', investment_fee_pct: 0.22 },
    ],
    data_as_at: '2025-01-01',
  },
...

  {
    ...
    investment_options: [
      { name: 'High Growth', total_fee_pct: 0.58 },
      { name: 'Growth', total_fee_pct: 0.56 },
      { name: 'Balanced', total_fee_pct: 0.55 },
      { name: 'Conservative', total_fee_pct: 0.54 },
      { name: 'Cash Plus', total_fee_pct: 0.40 },
    ],
    data_as_at: '2025-01-01',
  },

  {
    ...
    investment_options: [
      { name: 'SmartPath (born 1959–1963)', investment_fee_pct: 0.40 },
      { name: 'SmartPath (born 1964–1968)', investment_fee_pct: 0.38 },
      { name: 'SmartPath (born 1969–1973)', investment_fee_pct: 0.36 },
      { name: 'SmartPath (born 1974+)', investment_fee_pct: 0.34 },
      { name: 'High Growth', investment_fee_pct: 0.45 },
    ],
    data_as_at: '2025-06-01',
  },

  {
    ...
    investment_options: [
      { name: 'Lifestages 1990s', investment_fee_pct: 0.45 },
      { name: 'Lifestages 1980s', investment_fee_pct: 0.43 },
      { name: 'Lifestages 1970s', investment_fee_pct: 0.40 },
      { name: 'Lifestages 1960s', investment_fee_pct: 0.37 },
    ],
    data_as_at: '2025-01-01',
  },

  {
    ...
    investment_options: [
      { name: 'MLC Horizon 4 (Balanced)', investment_fee_pct: 0.50 },
      { name: 'MLC Horizon 5 (Growth)', investment_fee_pct: 0.54 },
      { name: 'MLC Horizon 3 (Conservative Growth)', investment_fee_pct: 0.46 },
      { name: 'MLC Cash Fund', investment_fee_pct: 0.20 },
    ],
...
const wrapPlatforms: ProductRow[] = [
...

  {
    ...
    investment_options: [
      { name: 'Grow Menu (flat)', total_fee_pct: 0.75 },
    ],
    data_as_at: '2025-09-30',
  },
