...
export const INTENTS = {
  super_at_age: {
    ...
    requiredFields: ['super_fund_name', 'date_of_birth', 'income', 'super_balance', 'intended_retirement_age', 'is_default_investment', 'super_investment_option'],
    fullLifecycle: false,
  ...
  super_longevity: {
    ...
    requiredFields: [
      ...
      'date_of_birth', 'income', 'super_balance',
  ...
  household_net_worth: {
    ...
    requiredFields: [
      'date_of_birth', 'relationship_status', 'income',
  ...
  compare_fund: {
    ...
    requiredFields: ['super_fund_name', 'date_of_birth', 'super_balance'],
    fullLifecycle: false,
    category: 'calculation',
    canvas: { showFeeImpact: true },
  ...
  compare_super_longevity: {
    ...
    requiredFields: [
      'super_fund_name', 'date_of_birth', 'income', 'super_balance',
      'intended_retirement_age', 'is_default_investment', 'super_investment_option',
      'relationship_status', 'retirement_expense_strategy',
    ],
    fullLifecycle: true,
